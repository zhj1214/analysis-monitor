import { options as sdkOptions, ReplaceHandler, setTraceId, subscribeEvent, transportData, triggerHandlers } from '@zhj/monitor-core' // '@zyf2e/monitor-core'
import { WxAppEvents, WxPageEvents, WxRouteEvents, WxEvents, EVENTTYPES, HTTPTYPE, voidFun } from '@zhj/monitor-shared' // '@zyf2e/monitor-shared'
import { getTimestamp, replaceOld, throttle, getFlag, isEmptyObject, variableTypeDetection, getCurrentRoute } from '@zhj/monitor-utils' // '@zyf2e/monitor-utils'
